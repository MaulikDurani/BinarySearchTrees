...
public class BinarySearchTree<T extends Comparable<T>> {
    ...
    /* Helper Methods */
    /**
     * Deprecated method for bug checking. Prints tree elements starting from the
     * root.
     *
     * By Ryan Majd
     * 
     * @deprecated For historical bug checking only. Avoid regular use.
     */
    @Deprecated
    public void toTree() {
        printTree(root, 0);
    ...
    /**
     * Deprecated method for bug checking. Recursively prints tree elements in an
     * in-order traversal.
     *
     * By Ryan Majd
     * 
     * @param root  Root of the tree or subtree to print.
     ...
     * The string is generated by performing an in-order traversal of the tree.
     * 
     * By Ryan Majd
     * 
     * @return a string representation of the binary search tree in in-order
     *         traversal.
     */
    @Override
